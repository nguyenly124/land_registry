...
//                         thống nhất và chính xác hơn thông qua nền tảng trực tuyến hiện đại, 
//                         nơi mọi dữ liệu được cập nhật và đồng bộ liên tục, 
//                         bảo đảm tính toàn vẹn và minh bạch trong quá trình quản lý.
//                     </label>

//                     <label >
//                         • Người dân có thể thực hiện hầu hết các thủ tục hành chính như tra cứu thông tin, 
//                         đăng ký, cập nhật và theo dõi tình trạng hồ sơ ngay tại nhà, 
//                         giúp tiết kiệm đáng kể thời gian, 
//                         chi phí và công sức so với phương thức truyền thống.
//                     </label>
                    
//                     <label >
//                         • Đây là bước tiến quan trọng trong việc 
//                         đưa dịch vụ công đến gần hơn với người dân, 
//                         xây dựng môi trường phục vụ chuyên nghiệp và thuận tiện.
//                     </label>

//                     <label >
//                         • Hệ thống còn đảm bảo mức độ bảo mật cao, 
//                         khả năng chia sẻ dữ liệu liên thông giữa các cơ quan quản lý, 
//                         góp phần nâng cao chất lượng phối hợp, 
//                         hạn chế sai sót và trùng lặp thông tin trong quá trình xử lý nghiệp vụ.
//                     </label>

//                     <label htmlFor="">
//                         • Góp phần thúc đẩy quá trình chuyển đổi số 
...
//                     <button 
//                         className="bg-blue-600 text-white font-semibold px-4 py-2 rounded hover:bg-white hover:text-blue-600 border-2 border-blue-600 w-40 h-12"
            ...
            <div className="flex flex-col justify-center items-center my-8">
                ...
                <div className="flex gap-5 justify-center">
                    ...
                    <button
                        ...
                        className={[
                        "font-semibold px-4 py-2 rounded border-2 w-40 h-12",
                        isLoggedIn
                            ? "bg-gray-300 text-gray-600 border-gray-300 cursor-not-allowed"
                            : "bg-blue-600 text-white hover:bg-white hover:text-blue-600 border-blue-600"
                        ].join(" ")}
                        title={isLoggedIn ? "Bạn đã đăng nhập" : "Nhấn để đăng nhập"}
                    >
                        {isLoggedIn ? "Đã đăng nhập" : "Bắt đầu"}
                    </button>
